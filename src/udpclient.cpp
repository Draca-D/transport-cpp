...
ConnectedHost Client::getSetHostAddr() const noexcept {
    return mHost;
}
...
IODevice::SYNC_RX_DATA Client::syncRequestResponse(const IODATA &data, const std::chrono::milliseconds &timeout) {
    SYNC_RX_DATA resp = {RETURN::NOK, {}};
