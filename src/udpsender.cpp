...
Sender::Sender() : NetworkDevice(), mHost({}) {}
...
bool Sender::isConnected() const noexcept { return mIsConnected; }

ConnectedHost Sender::getSetHostAddr() const noexcept { return mHost; }

RETURN_CODE Sender::connectToHost(const HostAddr &host,
